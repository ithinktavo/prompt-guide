...
> **How to use this file**: Copy everything below the line into your AI tool (GitHub Copilot Chat, Windsurf Chat, ChatGPT, etc.) and start a conversation. The AI will interview you about your problem and then generate a ready-to-use prompt.
